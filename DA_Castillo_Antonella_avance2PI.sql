...
INSERT INTO Ordenes (ClienteID, EmpleadoID, SucursalID, MensajeroID, TipodePagoID, OrigenID, HorarioVenta, TotalCompra, KilometroRecorrer, FechaDespacho, FechaEntrega, FechaOrdenTomada, FechaOrdenLista) VALUES
...
/*
¿Cuáles son las sucursales con un promedio de Facturación/Ingresos 
superior a 1000.00 y que minimizan sus costos en base al promedio de 
kilómetros recorridos de todas de sus entregas gestionadas? Para un mejor 
relevamiento, ordene el listado por el Promedio Km Recorridos
*/

SELECT SucursalID,
	   AVG (TotalCompra) AS Facturacion,
	   AVG (KilometroRecorrer) AS KmRecorridos
FROM Ordenes
GROUP BY SucursalID
